        ...
        <DescriptionContainer $height={descHeight}>
          <DescriptionWrapper>
            <DescriptionChildWrapper>
              ...
              <DescriptionsText>
                Consultants, integrators, and solution architects often get
                asked about service contracts and warranty models—but lack the
                infrastructure to deliver them. That’s where we come in
              </DescriptionsText>
            </DescriptionChildWrapper>
          </DescriptionWrapper>
...
const HeroImageWrapper = styled.div`
  ...
  background: linear-gradient(
    ...
    url("/assets/Consulting/consulting-hero-bg.webp") lightgray 50% / cover
      no-repeat;
`;
